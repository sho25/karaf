...
name|profileId
operator|+
literal|"' is invalid. Profile id must be: upper-case or lower-case letters, numbers, and . _ or - characters"
argument_list|)
expr_stmt|;
name|this
operator|.
...
block|}
block|}
comment|// Attributes are profile configuration properties with prefix "attribute." contained in "profile" PID
name|attributes
operator|=
name|getPrefixedMap
argument_list|(
...
name|BLACKLISTED_REPOSITORIES
argument_list|(
literal|"blacklisted.repository"
argument_list|)
block|;
specifier|private
name|String

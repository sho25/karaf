...
expr_stmt|;
block|}
comment|/**      * Configure project name to be used in consistency report      * @param consistencyReportProjectName      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Configure project version to be used in consistency report      * @param consistencyReportProjectVersion      */
specifier|public
name|void
...
name|warn
argument_list|(
literal|"Can't generate consistency report into {} - it's not a directory"
argument_list|,
name|generateConsistencyReport
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**      * Produces human readable XML with<em>feature consistency report</em>.      * @param repositories      * @param allInstalledFeatures      * @param installedProfile      * @param result      */
specifier|public
name|void
name|generateConsistencyReport
parameter_list|(
...
name|Feature
argument_list|>
name|effectiveInstalledFeatures
init|=
name|selector
operator|.
name|getMatching
...
name|write
argument_list|(
literal|"<consistency-report xmlns=\"urn:apache:karaf:consistency:1.0\" project=\""
operator|+
name|consistencyReportProjectName
operator|+
literal|"\" version=\""
...
condition|)
block|{
comment|//extract start-level for this bundle
name|String
name|level
init|=
name|location
...
name|debug
argument_list|(
literal|"new bundle location after strip start-level: "
operator|+
name|location
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// ensure input order is respected whatever hashmap/set was in the middle of the processing
specifier|final
name|List
argument_list|<
name|String

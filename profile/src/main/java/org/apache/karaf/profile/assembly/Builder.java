...
argument_list|)
expr_stmt|;
comment|//        Hashtable<String, String> agentProps = new Hashtable<>(overallEffective.getConfiguration(ORG_OPS4J_PAX_URL_MVN_PID));
comment|//        final Map<String, String> properties = new HashMap<>();
comment|//        properties.put("karaf.default.repository", "system");
comment|//        InterpolationHelper.performSubstitution(agentProps, properties::get, false, false, true);
comment|//
...
argument_list|>
argument_list|>
name|optionalVersionFeatureMap
init|=
name|Optional
operator|.
name|ofNullable

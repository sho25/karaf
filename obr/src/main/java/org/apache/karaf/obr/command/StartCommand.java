...
name|description
operator|=
literal|"List of bundles to deploy (separated by whitespaces). The bundles are identified using the following syntax: symbolic_name,version where version is optional."
argument_list|,
name|required
operator|=
literal|true

...
name|name
operator|=
literal|"repository-change"
argument_list|,
name|description
operator|=
literal|"Changes configuration of Maven repository"
argument_list|)
annotation|@
name|Service
specifier|public
class|class
name|RepositoryChangeCommand
extends|extends
...
condition|)
block|{
comment|// find<repository> in any active profile to change it
for|for
control|(
name|Profile
name|profile
...
condition|)
block|{
comment|// I can't imagine it's not...
name|Repository
name|r
init|=
name|repository

...
literal|true
decl_stmt|;
comment|/**      * Environment variable for specifying extra options to the Karaf admin       * process kicked off from this Java process.      */
specifier|private
specifier|static
specifier|final
name|String
...
literal|"KARAF_OPTS"
decl_stmt|;
comment|/**      * System property for specifying extra options to the Karaf admin       * process kicked off from this Java process.      */
specifier|private
specifier|static
specifier|final
name|String

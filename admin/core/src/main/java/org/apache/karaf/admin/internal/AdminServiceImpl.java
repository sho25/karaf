...
argument_list|)
expr_stmt|;
comment|// remote the old instance
name|instances
operator|.
name|remove
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// load the etc/system.properties
comment|// TODO use Karaf util Properties to preserve the comment and format of the original properties file
name|Properties
...
argument_list|)
expr_stmt|;
comment|// TODO update the bin/karaf, bin/start and bin/stop scripts (and/or corresponding .bat scripts)

...
name|MBeanException
function_decl|;
comment|/**      * Add new properties or update existing ones (without removing others) in a given configuration.      *      * @param pid the configuration PID.      * @param properties the properties to add/update.      * @throws MBeanException in case of MBean failure.      */
name|void
name|append
parameter_list|(
name|String
...
name|MBeanException
function_decl|;
comment|/**      * Delete properties from a configuration.      *      * @param pid the configuration PID.      * @param properties the properties to delete from the configuration.      * @throws MBeanException in case of MBean failure.      */
name|void
name|delete
parameter_list|(
name|String

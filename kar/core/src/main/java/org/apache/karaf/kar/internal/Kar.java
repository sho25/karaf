...
expr_stmt|;
block|}
comment|/**      * Extract a kar from a given URI into a repository dir and resource dir      * and populate shouldInstallFeatures and featureRepos      *       * @param karUri uri to read the kar from      * @param repoDir directory to write the repository contents of the kar to      * @param resourceDir directory to write the resource contents of the kar to      */
specifier|public
name|void
name|extract
parameter_list|(

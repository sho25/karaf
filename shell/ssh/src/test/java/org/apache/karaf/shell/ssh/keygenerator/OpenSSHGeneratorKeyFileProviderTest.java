...
argument_list|)
decl_stmt|;
comment|// First we try to load without specifying a password...
name|OpenSSHKeyPairProvider
name|prov
init|=
operator|new
...
name|fail
argument_list|(
literal|"Failure expected on a decryption failure"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
comment|// expected
block|}
comment|// Now we provide the wrong password
name|prov
operator|=
operator|new
name|OpenSSHKeyPairProvider

...
return|;
block|}
comment|/**      * This blueprint type converter silently converts instances of      *<code>Class X implements NameFactory</code>      * to the reified type<code>cNameFactory</code>      * and therefore helps blueprint to set the returned factories on      * {@link SshServerAction#setUserAuthFactories(List)} without complaining      * about type conversion errors.      */
specifier|public
specifier|static
class|class
name|Converter

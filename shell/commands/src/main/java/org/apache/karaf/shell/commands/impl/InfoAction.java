...
name|description
operator|=
literal|"Includes detailed information about memory pools"
argument_list|)
specifier|protected
name|boolean
name|showMemoryPools
decl_stmt|;
comment|//    @Reference
name|List
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// PeakUsage/CurrentUsage
name|MemoryUsage
name|peakUsage
init|=
name|pool
...
parameter_list|()
block|{
comment|// In Java 9 the new process API can be used:
comment|// long pid = ProcessHandle.current().getPid();
name|String
name|name
init|=
name|ManagementFactory

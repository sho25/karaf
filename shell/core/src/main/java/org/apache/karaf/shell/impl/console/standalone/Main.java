...
name|getPackage
argument_list|(
literal|"org.apache.karaf.shell.impl.console.standalone"
argument_list|)
decl_stmt|;
if|if
condition|(
...
argument_list|)
decl_stmt|;
comment|// Load jars in class path to be able to load jars inside them
name|ClassLoader
name|tmpClassLoader
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// Create ClassLoader with jars in jars and parent main ClassLoader
name|cl
operator|=
operator|new
name|URLClassLoader
...
argument_list|)
expr_stmt|;
comment|// Load original Jars with jarsInJars ClassLoader as parent.
comment|// This is needed cause if you load Class from main jar which depends on class in inner jar.
comment|// The loaded class has its class loader and resolve dependant classes in its or parent classloaders
comment|// which exclude jarInJar classloader.
name|cl
operator|=
operator|new
name|URLClassLoader

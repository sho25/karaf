...
argument_list|()
expr_stmt|;
comment|// We may not have the perms to read the history file...
if|if
condition|(
name|file
operator|.
...
condition|)
block|{
comment|// Override the FileHistory impl to trap failures due to the
comment|// user does not having write access to the history file.
name|reader
operator|.
name|setHistory
argument_list|(
...
name|debug
argument_list|(
literal|"Cold not write history file: "
operator|+
name|file
argument_list|,
name|e
...
name|debug
argument_list|(
literal|"Cold not delete history file: "
operator|+
name|file
argument_list|,
name|e

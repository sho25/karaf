...
condition|)
block|{
comment|// filter on subshell
comment|// as the completion mode is set to SUBSHELL, we complete only with the commands local
comment|// to the current subshell
if|if
condition|(
name|command
operator|.
...
if|if
condition|(
literal|"org.apache.felix.gogo.runtime.CommandProxy"
operator|.
name|equals
argument_list|(
name|function

...
expr_stmt|;
block|}
comment|/**      * Returns whether or not we are in multi-scope mode.      *      * The default mode is multi-scoped where we prefix commands by their scope. If we are in single      * scoped mode then we don't use scope prefixes when registering or tab completing commands.      */
specifier|public
name|boolean
name|isMultiScopeMode
parameter_list|()

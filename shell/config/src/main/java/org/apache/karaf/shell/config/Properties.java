...
expr_stmt|;
block|}
comment|/**      * Reads a properties file and stores its internal structure. The found      * properties will be added to the associated configuration object.      *      * @param in the reader to the properties file      * @throws IOException if an error occurs      */
specifier|protected
name|void
name|loadLayout
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Writes the properties file to the given writer, preserving as much of its      * structure as possible.      *      * @param out the writer      * @throws IOException if an error occurs      */
specifier|protected
name|void
name|saveLayout
parameter_list|(

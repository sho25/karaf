...
return|;
block|}
comment|/**      * Returns the JAAS Realm named as realmName.      *      * @param realmName the name of the JAAS Realm.      * @return the corresponding<code>JaasRealm</code>.      */
specifier|public
name|JaasRealm
name|findRealm
parameter_list|(
...
return|;
block|}
comment|/**      * Returns the JAAS Module entry of the specified realm, identified by the given name.      *      * @param realm the JAAS realm.      * @param moduleName the JAAS module name.      * @return the corresponding<code>AppConfigurationEntry</code>.      */
specifier|public
name|AppConfigurationEntry

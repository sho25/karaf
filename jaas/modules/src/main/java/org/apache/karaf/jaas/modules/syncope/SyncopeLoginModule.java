...
return|;
block|}
comment|/**      * Extract the user roles from the JSON provided by Syncope 2.x.      *      * @param response the HTTP response from Syncope.      * @return the list of user roles.      * @throws Exception in case of extracting failure.      */
annotation|@

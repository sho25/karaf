...
argument_list|,
literal|"instance,package,log,ssh,framework,system,eventadmin,feature,shell,management,service,jaas,deployer,diagnostic,wrap,bundle,config,kar,aries-blueprint,shell-compat,activemq-broker-noweb"
argument_list|)
argument_list|)
expr_stmt|;
return|return

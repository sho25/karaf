...
begin_comment
comment|/**  * Generates the dependencies properties file  *  * @version $Revision: 1.1 $  * @goal generate-depends-file  * @phase generate-resources  * @requiresDependencyResolution runtime  * @description Generates the dependencies properties file  */
end_comment

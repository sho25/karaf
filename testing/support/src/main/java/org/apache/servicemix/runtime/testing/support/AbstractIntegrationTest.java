...
argument_list|,
literal|"org.apache.servicemix.bundles.aopalliance-1.0"
argument_list|)
block|,
name|getBundle
argument_list|(
literal|"org.apache.servicemix.bundles"
argument_list|,
literal|"org.apache.servicemix.bundles.asm-2.2.3"
argument_list|)
block|,
name|getBundle
argument_list|(
literal|"org.apache.servicemix.bundles"
argument_list|,
literal|"org.apache.servicemix.bundles.junit-4.4"
argument_list|)
block|,
name|getBundle
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*         if (isSnapshot(version)) {             location.append("SNAPSHOT");         } else {             location.append(version);         }         */
name|location
operator|.
name|append
argument_list|(
...
name|matches
argument_list|(
literal|".+-(\\d\\d\\d\\d\\d\\d\\d\\d\\.\\d\\d\\d\\d\\d\\d-\\d+|SNAPSHOT)"
argument_list|)
return|;
block|}
specifier|public

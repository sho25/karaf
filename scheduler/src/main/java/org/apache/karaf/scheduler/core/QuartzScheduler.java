...
argument_list|(
literal|"Unable to create quartz scheduler"
argument_list|,
name|t
argument_list|)
throw|;
...
name|debug
argument_list|(
literal|"Update job scheduling {} with name {} and trigger {}"
argument_list|,
name|job
argument_list|,
name|jobName

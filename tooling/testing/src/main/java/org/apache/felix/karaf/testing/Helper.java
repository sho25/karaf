...
return|;
block|}
comment|/**      * Return an array of pax-exam options to correctly configure the osgi      * framework for karaf.      *      * @return default pax-exam options for karaf osgi framework      */
specifier|public
specifier|static
name|Option
index|[]
...
return|;
block|}
comment|/**      * Return an array of pax-exam options to configure the osgi      * framework for karaf, given the system properties and the      * location of the osgi framework properties file.      *      * @param sysProps karaf system properties      * @param configProperties the URL to load the osgi framework properties from      * @return pax-exam options for karaf osgi framework      */
specifier|public
specifier|static
name|Option
index|[]

...
name|startsWith
argument_list|(
literal|"org.apache.felix.service."
argument_list|)
condition|)
block|{
name|elem
...
parameter_list|)
block|{
comment|//in eclipse, the dependencies.properties may not be avail since it's not
comment|//generated into a source directory (directly into classes).
comment|//thus, try and load it manually
try|try
block|{
name|File
name|file
...
name|getResource
argument_list|(
literal|"/org/apache/karaf/testing/config.properties"
argument_list|)
argument_list|,
name|sysOptions
argument_list|)
...
name|getResource
argument_list|(
literal|"/org/apache/karaf/testing/startup.properties"
argument_list|)
argument_list|)
return|;
block|}
...
argument_list|,
literal|"org.apache.karaf.tooling.testing"
argument_list|)
argument_list|)
expr_stmt|;
name|options
...
expr_stmt|;
block|}
comment|// Add ServiceMix junit bundle
name|JUnitBundlesOption
name|jubo
init|=
operator|new
...
return|;
block|}
comment|/**      * Configures the required system property to set the log-level in Karaf.      *      * @param logLevel the log level which should be used for pax-logging. Possible values are TRACE, DEBUG, INFO, WARN,      *        ERROR and FATAL      * @return a pax-exam option      */
specifier|public
specifier|static
name|SystemPropertyOption
name|setLogLevel
...
return|;
block|}
comment|/**      * Method to directly register Karaf standard features.      *      * @param features a list of features which should be loaded from the Karaf standard feature file.      * @return a pax-exam option      */
specifier|public
specifier|static
name|FeaturesScannerProvisionOption
...
return|;
block|}
comment|/**      * Method to directly register Karaf enterprise features.      *       * @param features a list of features which should be loaded from the Karaf enterprise feature file.      * @return a pax-exam option      */
specifier|public
specifier|static
name|FeaturesScannerProvisionOption
name|loadKarafEnterpriseFeatures
parameter_list|(
name|String
modifier|...
name|features
...
return|;
block|}
comment|/**      * Returns the vmOption to configure pax exam with debugging support.      *      * @param debuggingPort the port where the remote debugger should be allowed to be attached      * @return the option to enable debugging      */
specifier|public
specifier|static
name|Option
name|activateDebugging
parameter_list|(
name|String
name|debuggingPort
parameter_list|)
...
name|vmOption
argument_list|(
literal|"-Xrunjdwp:transport=dt_socket,server=y,suspend=y,address="
operator|+
name|debuggingPort
argument_list|)
return|;

...
return|;
block|}
comment|/**      * Method to directly register Karaf features.      *      * @param features a list of features which should be loaded from the Karaf feature file.      * @return a pax-exam option      */
specifier|public
specifier|static
name|FeaturesScannerProvisionOption

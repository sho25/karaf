...
begin_comment
comment|/**  * Pre configured property file pointers to the most commonly used properties in /etc/config.properties and  * /etc/custom.properties.  */
end_comment
...
decl_stmt|;
comment|/**      * Possible values here are felix or equinox      */
specifier|static
specifier|final
name|ConfigurationPointer

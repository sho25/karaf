...
name|KarafExamSystemConfigurationOption
index|[]
name|internalConfigurationOptions
init|=
name|system
operator|.
name|getOptions
...
block|{
comment|// if special file warn, replace and continue
if|if
condition|(
operator|!
name|option
...
name|warn
argument_list|(
literal|"you're trying to add an additional value to a config file; you're current "
operator|+
literal|"value will be replaced."
argument_list|)
expr_stmt|;
name|optionEntries
operator|.

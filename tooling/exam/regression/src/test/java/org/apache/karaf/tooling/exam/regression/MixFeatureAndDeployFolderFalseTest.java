...
begin_comment
comment|/**  * This test should validate if the versionAsInProject tags work as expected.  */
end_comment
...
specifier|public
class|class
name|MixFeatureAndDeployFolderFalseTest
block|{
annotation|@
name|Inject
specifier|private
...
name|BOOT
argument_list|,
literal|"config,standard,region,package,ssh"
argument_list|)
block|,
name|scanFeatures
argument_list|(

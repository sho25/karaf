...
specifier|public
class|class
name|DuplicatedPropertyEntryFromFileTest
block|{
annotation|@
name|Inject
specifier|private
...
name|editConfigurationFileExtend
argument_list|(
literal|"etc/tests.cfg"
argument_list|,
operator|new
name|File
argument_list|(
literal|"src/test/resources/BaseKarafDefaultFrameworkDuplicatedPropertyEntryTestFirstKey"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
name|File
argument_list|(
literal|"src/test/resources/BaseKarafDefaultFrameworkDuplicatedPropertyEntryTestSecondKey"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;

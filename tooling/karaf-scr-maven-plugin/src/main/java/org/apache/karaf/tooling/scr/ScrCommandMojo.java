...
argument_list|(
literal|"Multiple methods annotated with @Init found"
argument_list|)
throw|;
block|}
block|}
...
name|IllegalArgumentException
argument_list|(
literal|"Multiple methods annotated with @Destroy found"
argument_list|)
throw|;
block|}
block|}
...
argument_list|()
decl_stmt|;
comment|//        System.out.println("Roots: " + roots);
comment|//        System.out.println("Paths: " + paths);
for|for
control|(
name|String
name|path

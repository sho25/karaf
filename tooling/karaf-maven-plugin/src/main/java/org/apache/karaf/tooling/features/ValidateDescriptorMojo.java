...
literal|false
decl_stmt|;
comment|/*     * A map to cache the mvn: uris and the artifacts that correspond with them if it's mvn protocol     * or just uris itself if it's non mvn protocol     */
specifier|private
name|Map
argument_list|<
name|String
...
block|}
block|}
comment|/**      * Checks feature repository with XML Schema.      *      * @param repository Repository object.      * @param uri        Display URI.      */
specifier|private
name|void
name|schemaCheck
parameter_list|(
...
name|error
argument_list|(
literal|"Failed to validate repository %s. Schema validation fails. Fix errors to continue validation"
argument_list|,
name|e
argument_list|,
name|uri
...
expr_stmt|;
block|}
comment|/**      * Add Karaf core features URL in the default repositories set      */
specifier|private
name|void
name|appendKarafCoreFeaturesDescriptors
parameter_list|()
...
block|}
name|String
name|karafCoreStandardFeaturesUrl
init|=
name|String
operator|.
name|format
...
decl_stmt|;
name|String
name|karafCoreEnterpriseFeaturesUrl
init|=
name|String
operator|.
name|format
...
name|karafCoreStandardFeaturesUrl
operator|+
literal|" in the default repositories set"
argument_list|)
expr_stmt|;
block|}
try|try
...
name|format
argument_list|(
literal|" - adding repository from %s"
argument_list|,
name|uri
argument_list|)
argument_list|)
...
expr_stmt|;
block|}
comment|// add the dependency feature exports
name|exports
operator|.
name|addAll
argument_list|(
name|getDependencyFeatureExports
argument_list|(
name|feature
argument_list|)
argument_list|)
...
block|}
block|}
comment|/*      * Get a list of bundle locations in a feature      */
specifier|private
name|List
argument_list|<
name|String
...
expr_stmt|;
block|}
comment|// add the export of the feature
for|for
control|(
name|String
name|bundle
...
block|}
block|}
comment|// add the exports for dependency feature
name|exports
operator|.
name|addAll
argument_list|(
...
condition|)
block|{
comment|// avoid going over to the repository if the file is already on
comment|// the disk
name|file
operator|=
operator|new

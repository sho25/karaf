...
argument_list|)
decl_stmt|;
comment|// artifact1 is created with explicit classifier "bin", which is dropped below when attachArtifact is called
comment|// which means we can't use artifact1.equals(artifact) directly with artifact1
name|Artifact
name|artifact2
init|=
name|factory

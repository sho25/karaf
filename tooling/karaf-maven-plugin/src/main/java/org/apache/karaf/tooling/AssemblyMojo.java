...
name|javase
decl_stmt|;
comment|/**      * Specify which framework to use      * (one of framework, framework-logback, static-framework, static-framework-logback).      */
annotation|@
name|Parameter
specifier|protected
name|String
...
argument_list|)
expr_stmt|;
comment|// Set up config and system props
if|if
condition|(
name|config
operator|!=

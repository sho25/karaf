...
return|;
block|}
comment|/**      * Convert a Aether coordinate format into a filesystem path.      *      * @param name the Aether coordinate format (<groupId>:<artifactId>[:<extension>[:<classifier>]]:<version>)      * @return the filesystem path      */
specifier|static
name|String
name|pathFromAether
parameter_list|(
...
return|;
block|}
comment|/**      * Convert an Aether<code>org.sonatype.aether.artifact.Artifact</code> into a PAX URL mvn format.      *      * @param artifact the Aether<code>org.sonatype.aether.artifact.Artifact</code>.      * @return the corresponding PAX URL mvn format (mvn:<groupId>/<artifactId>/<version>/<type>/<classifier>)      */
specifier|static
name|String
name|artifactToMvn
parameter_list|(

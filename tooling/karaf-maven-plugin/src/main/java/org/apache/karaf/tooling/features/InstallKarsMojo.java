...
argument_list|()
decl_stmt|;
comment|// loading kar and features repositories
name|getLog
argument_list|()
operator|.
name|info
...
expr_stmt|;
block|}
comment|// installing condition features
for|for
control|(
name|Conditional
name|conditional
...
name|info
argument_list|(
literal|"= Installing conditional "
operator|+
name|conditional
operator|.
name|getCondition
...
name|debug
argument_list|(
literal|"== Conditional configuration files"
argument_list|)
expr_stmt|;
if|if
condition|(
...
condition|)
block|{
comment|// cleanup the URL containing the repository location directly in the URL
name|int
name|index
init|=
name|bundleLocation

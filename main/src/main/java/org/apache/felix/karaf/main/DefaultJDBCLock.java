...
return|;
block|}
comment|/*      * (non-Javadoc)      * @see org.apache.felix.karaf.main.Lock#lock()      */
specifier|public
name|boolean
name|lock
parameter_list|()
...
return|;
block|}
comment|/*      * (non-Javadoc)      * @see org.apache.felix.karaf.main.Lock#release()      */
specifier|public
name|void
name|release
parameter_list|()
...
expr_stmt|;
block|}
comment|/*      * (non-Javadoc)      * @see org.apache.felix.karaf.main.Lock#isAlive()      */
specifier|public
name|boolean
name|isAlive
parameter_list|()

...
begin_comment
comment|/**  * Represents an exclusive lock on a database,  * used to avoid multiple SMX instances attempting  * to become master.  *   * @version $Revision: $  */
end_comment
...
block|}
block|}
comment|/**      * obtainLock - obtain the lock connection.      *      * @throws Exception      */
specifier|private
name|void
name|obtainLock
parameter_list|()

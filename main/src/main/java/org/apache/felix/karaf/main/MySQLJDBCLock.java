...
name|fine
argument_list|(
literal|"DefaultJDBCLock#setUpdateCursor:: connection: "
operator|+
name|url
operator|+
literal|"/"
...
name|fine
argument_list|(
literal|"MySQLJDBCLock#setUpdateCursor:: connection already established."
argument_list|)
expr_stmt|;
return|return
literal|true
...
name|fine
argument_list|(
literal|"MySQLJDBCLock#lock:: have set Update Cursor, now do update"
argument_list|)
expr_stmt|;
name|long
name|time
...
name|fine
argument_list|(
literal|"MySQLJDBCLock#lock:: Number of update rows: "
operator|+
name|rows
argument_list|)
expr_stmt|;

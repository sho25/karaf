...
specifier|private
name|String
name|lockVerifySelectionNotEmptyStatement
decl_stmt|;
specifier|public
name|String
index|[]
...
specifier|public
name|void
name|setLockVerifySelectionNotEmptyStatement
parameter_list|(
name|String
name|lockVerifySelectionNotEmptyStatement
parameter_list|)
...
condition|)
block|{
comment|//The lock create and lock update are perfomed on the whole table instead of
comment|//the cluster. So not taking the node into account for now.
name|lockVerifySelectionNotEmptyStatement
operator|=

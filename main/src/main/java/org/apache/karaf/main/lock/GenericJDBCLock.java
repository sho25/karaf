...
try|try
block|{
comment|// Reset the auto commit to true
name|connection
operator|.
name|setAutoCommit
argument_list|(
...
name|FINE
argument_list|,
literal|"Exception while setting the connection auto commit"
argument_list|,
name|ignored
argument_list|)
expr_stmt|;
...
name|SEVERE
argument_list|,
literal|"Received an exception while trying to get a reference to a connection"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**      * This method is called to determine if this instance JDBC connection is      * still connected.      *      * @return True, if the connection is still connected else false.      * @throws SQLException If an SQL error occurs while checking if the lock is connected to the database.      */
name|boolean
name|isConnected
parameter_list|()
throws|throws
...
return|;
block|}
comment|/**      * Create a new JDBC connection.      *      * @param driver The fully qualified driver class name.      * @param url The database connection URL.      * @param username The username for the database.      * @param password  The password for the database.      * @return a new JDBC connection.      * @throws Exception If the JDBC connection can't be created.      */
specifier|protected
name|Connection
name|createConnection
parameter_list|(
...
block|}
block|}
comment|/**      * This method could be used to inject a mock JDBC connection for testing purposes.      *      * @param driver The fully qualified driver class name.      * @param url The database connection URL.      * @param username The username for the database.      * @param password The password for the database.      * @return a new JDBC connection.      * @throws ClassNotFoundException If the JDBC driver class is not found.      * @throws SQLException If the JDBC connection can't be created.      */
specifier|protected
name|Connection
name|doCreateConnection
parameter_list|(

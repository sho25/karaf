...
return|;
block|}
comment|/**      * Create a new jdbc connection.      *      * @param driver The fully qualified driver class name      * @param url  The database connection url      * @param username The username for the database      * @param password  The password for the data      * @return a new jdbc connection      * @throws Exception      */
specifier|protected
name|Connection
name|createConnection
parameter_list|(

...
name|info
argument_list|(
literal|"Installing and starting bundles from "
operator|+
name|startupPropsFile
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Installing and starting bundles from startup feature uri "
operator|+
name|config
operator|.
name|startupFeatureUri
...
name|config
operator|.
name|startupFeatureName
argument_list|)
expr_stmt|;
name|URI
name|resolvedStartupFeatureUri
init|=
name|resolver
operator|.
name|resolve
...
argument_list|(
literal|"No bundles loaded. You either need a etc/startup.properties or set "
operator|+
name|ConfigProperties
operator|.
name|KARAF_STARTUP_FEATURE_URI
operator|+
literal|" in config.properties"
argument_list|)
throw|;
block|}
name|LOG
...
name|numBundles
operator|+
literal|" initial bundles installed and set to start"
argument_list|)
expr_stmt|;
block|}
name|ServerInfo

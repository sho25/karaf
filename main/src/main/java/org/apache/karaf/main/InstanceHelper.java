...
block|}
block|}
comment|/* KARAF-5798: consistent way to obtain the process ID */
specifier|private
specifier|static
name|String
name|getPid
...
argument_list|()
decl_stmt|;
comment|/*          * RuntimeMXBean#getName() makes no guarantees about the name, so use a          * regex to match the common(?) "pid@host" format          */
name|Pattern
name|pattern
init|=
name|Pattern
...
return|;
block|}
comment|/* KARAF-5798: now called by Main#launch() */
specifier|static
name|void
name|writePid
parameter_list|(

...
name|MainService
block|{
comment|/**listed in startup.properties configuration not found      * The system property name used to specify an URL to the system      * property file.     **/
specifier|public
specifier|static
specifier|final
name|String
...
specifier|final
name|String
name|STARTUP_PROPERTIES_FILE_VALUE
init|=

...
name|EventListener
block|{
comment|/** 	 * Receives notification that a service has had a lifecycle change. 	 *  	 * @param event The {@code ServiceEvent} object. 	 */
specifier|public
name|void
name|serviceChanged
parameter_list|(

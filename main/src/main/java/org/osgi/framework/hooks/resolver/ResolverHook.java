...
name|ResolverHook
block|{
comment|/** 	 * Filter resolvable candidates hook method.  This method may be called 	 * multiple times during a single resolve process. 	 * This method can filter the collection of candidates by removing  	 * potential candidates.  Removing a candidate will prevent the candidate 	 * from resolving during the current resolve process.  	 *  	 * @param candidates the collection of resolvable candidates available during 	 * a resolve process.  	 */
name|void
...
parameter_list|)
function_decl|;
comment|/** 	 * This method is called once at the end of the resolve process. 	 * After the end method is called the resolve process has ended. 	 * The framework must not hold onto this resolver hook instance 	 * after end has been called. 	 */
name|void
name|end
parameter_list|()
function_decl|;

...
specifier|public
name|void
name|testRetainsMasterLockOverFluctuation
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testLostMasterLockAfterThreshold
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// lets wait until the start level change is complete - thrice
comment|// (lostThreshold)
name|Thread
operator|.
name|sleep
argument_list|(

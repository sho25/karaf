...
specifier|public
name|void
name|testFragmentWithThreeHosts
parameter_list|()
throws|throws
name|IOException
block|{
...
name|hostFilter
init|=
literal|"(&(osgi.wiring.host=our-host)(bundle-version>=0.0.0))"
decl_stmt|;
name|long
name|host1BundleId
init|=
...
argument_list|()
decl_stmt|;
comment|// the save order isn't guaranteed (a Set is used internally), so we need to collect the info first
name|Set
argument_list|<
name|String
argument_list|>
...
specifier|public
name|void
name|testFilterCandidatesSelfSatisfiedCapability
parameter_list|()
throws|throws
name|IOException
block|{
comment|// no wires are created with itself
name|Bundle
name|bundle
init|=
name|wiredBundle

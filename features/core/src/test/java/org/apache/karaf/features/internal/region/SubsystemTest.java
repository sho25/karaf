...
specifier|public
name|void
name|testOverridesCompatibilityModeSymbolicNameMatches
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// this is normally done by features processor
operator|(
operator|(
name|Bundle
operator|)
...
specifier|public
name|void
name|testOverridesCompatibilityModeSymbolicDoesNotMatch
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// we expect override not to be used - symbolic name between a and c doesn't match
name|Map
argument_list|<
name|String
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// we expect override to be used - symbolic name between a and c doesn't match, but we don't care
name|Map
argument_list|<
name|String
argument_list|,
...
argument_list|()
decl_stmt|;
comment|// we expect only bundle "a", as "b" is blacklisted
name|addToMapSet
argument_list|(
name|expected
argument_list|,

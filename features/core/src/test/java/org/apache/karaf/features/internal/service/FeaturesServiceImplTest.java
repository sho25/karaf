...
name|assertFalse
argument_list|(
literal|"a1 feature should not be installed anymore after removal of repo"
argument_list|,
name|impl
operator|.
name|isInstalled
...
argument_list|)
expr_stmt|;
comment|/*         assertFalse("b1 feature should not be installed anymore after removal of repo",                     impl.isInstalled(b1Feature));         */
name|assertTrue
argument_list|(
literal|"b1 feature still present -> issue KARAF-5123 is not yet fixed"
argument_list|,
name|impl
operator|.
name|isInstalled

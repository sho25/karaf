...
specifier|private
name|long
name|regionsPersistenceTimeout
init|=
literal|5000
decl_stmt|;
specifier|public
...
expr_stmt|;
block|}
comment|/**      * Returns a RegionsPersistence service.      * @param timeout      * @return      */
specifier|protected
name|RegionsPersistence
...
name|warn
argument_list|(
literal|"Interrupted while waittng for RegionsPersistence service"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|registerRegionsPersistence
parameter_list|(
name|RegionsPersistence
name|regionsPersistence
parameter_list|)
...
specifier|public
name|void
name|unregisterRegionsPersistence
parameter_list|(
name|RegionsPersistence
name|regionsPersistence
parameter_list|)
...
block|}
block|}
comment|/**      * Refreshes the url.      * @param url      * @throws Exception      */
specifier|protected
name|void
name|refreshRepository
parameter_list|(
...
name|addAll
argument_list|(
name|findBundlesWithFramentsToRefresh
argument_list|(
name|state
argument_list|)
argument_list|)
...
name|Exception
block|{
comment|// Register FrameworkEventListener
name|bundleContext
operator|.

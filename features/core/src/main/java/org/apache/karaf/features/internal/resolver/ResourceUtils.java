...
block|}
block|}
comment|// If there is no location value, then just return the saved URL
if|if
condition|(
name|location
operator|==
...
return|;
block|}
comment|// If the saved is absolute (i.e. well-formed), then return it
try|try
block|{
operator|new
name|URL
...
parameter_list|)
block|{
comment|// The URL is relative, so return the absolute URL
return|return
name|location
operator|+
name|url

...
return|;
block|}
comment|/**      *<p>Perform<em>compilation</em> of rules declared in feature processing XML file.</p>      *<p>Additional blacklist and overrides definitions will be added to this model</p>      *      * @param blacklist additional {@link Blacklist} definition with lower priority      * @param overrides additional overrides definition with lower priority      */
specifier|public
name|void
name|postUnmarshall
parameter_list|(
...
parameter_list|)
block|{
comment|// configure Blacklist tool
name|List
argument_list|<
name|String
argument_list|>
...
argument_list|()
decl_stmt|;
comment|// compile blacklisted repository URIs (from XML and additional blacklist)
name|blacklist
operator|.
...
block|}
block|}
comment|// add external blacklisted features to this model
name|blacklist
operator|.
...
argument_list|)
expr_stmt|;
comment|// add external blacklisted bundle URIs to this model
name|blacklist
operator|.
...
argument_list|)
expr_stmt|;
comment|// verify bundle override definitions (from XML and additional overrides)
name|bundleReplacements
operator|.
...
block|}
block|}
comment|/**      * Changes overrides list (old format) into a list of {@link BundleReplacements.OverrideBundle} definitions.      * @param overrides      * @return      */
specifier|public
specifier|static
name|Collection
argument_list|<

...
name|error
argument_list|(
literal|"Could not load feature repository: "
operator|+
name|ex
operator|.
name|getMessage
...
expr_stmt|;
block|}
comment|// Check the value of the "dependency" attribute
if|if
condition|(
name|bDependency
operator|!=
...
name|error
argument_list|(
literal|"The start-level is not an int value for the bundle : "
operator|+
name|b
operator|.
name|getTextContent

...
argument_list|()
decl_stmt|;
comment|/**      *<p>Creates instance of features processor using 1 external URI, additional {@link Blacklist} instance      * and additional set of override clauses.</p>      * @param featureModificationsURI      * @param blacklistDefinitions      * @param overrides      */
specifier|public
name|FeaturesProcessorImpl
parameter_list|(
name|String
...
expr_stmt|;
block|}
comment|/**      *<p>Creates instance of features processor using 3 external (optional) URIs.</p>      * @param featureModificationsURI      * @param blacklistedURI      * @param overridesURI      */
specifier|public
name|FeaturesProcessorImpl
parameter_list|(
name|String

...
comment|// If noStart is true, we don't want to start the newly installed features
comment|// but we still want old features to be started.
name|Set
argument_list|<
name|Resource
argument_list|>
...
comment|//  - create flag files to indicate the resolution must be continued after restart
...
comment|//
comment|//
comment|// Find start levels to update
comment|//
name|Map
argument_list|<
name|Bundle
...
argument_list|)
decl_stmt|;
comment|// Iterate through previously managed regions and
comment|// delete those that do not contain any bundles anymore
for|for
control|(
name|String
name|name
...
comment|// TODO: add region information and avoid flattening
for|for
control|(
name|Feature
name|feature

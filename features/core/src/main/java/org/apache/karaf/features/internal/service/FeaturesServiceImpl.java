...
name|Exception
block|{
name|makeSureFeatureCacheLoaded
argument_list|()
expr_stmt|;
synchronized|synchronized
init|(
...
name|map
init|=
name|createFeatureCacheInternal
argument_list|()
decl_stmt|;
synchronized|synchronized
init|(
...
condition|)
block|{
comment|// Only update cache if list of repositories was not changed in the mean time
name|featureCache
operator|=
name|map
expr_stmt|;

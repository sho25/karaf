...
parameter_list|()
block|{
comment|// TODO: catching this exception is ugly: refactor the api
try|try
block|{
name|getFeatures
argument_list|()
...
name|managed
parameter_list|,
comment|// currently managed bundles
name|EnumSet
argument_list|<
name|Option
argument_list|>
...
comment|// TODO: regions: on isolated regions, we may need different resolution for each region
name|Set
argument_list|<
name|String
argument_list|>
...
argument_list|)
decl_stmt|;
comment|// TODO: is there are a way to use fragments or on-demand resources
comment|// TODO: in the resolver to use a single resolution ?
name|boolean
name|resolveAgain
init|=
literal|false
...
condition|)
block|{
comment|// This requirement is an optional import package
for|for
control|(
name|Bundle
name|provider

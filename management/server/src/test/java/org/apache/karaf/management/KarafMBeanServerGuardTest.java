...
specifier|public
name|void
name|testRequiredRolesHierarchyCanonical
parameter_list|()
throws|throws
name|Exception
block|{
...
name|SERVICE_PID
argument_list|,
literal|"jmx.acl.foo.bar.Test.AAA.BBB"
argument_list|)
expr_stmt|;
name|ConfigurationAdmin
name|ca
...
name|getInstance
argument_list|(
literal|"foo.bar:prop1=AAA,prop2=BBB,type=Test"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
literal|"Canonical ObjectName should work"
argument_list|,
name|Collections
operator|.
name|singletonList
...
argument_list|)
expr_stmt|;
comment|// Non-canonical object name
name|ObjectName
name|on2
init|=
name|ObjectName
...
name|getInstance
argument_list|(
literal|"foo.bar:type=Test,prop2=BBB,prop1=AAA"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
literal|"Non-canonical ObjectName should also work"
argument_list|,
name|Collections
operator|.
name|singletonList

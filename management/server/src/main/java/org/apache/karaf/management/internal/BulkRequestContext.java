...
name|configAdmin
decl_stmt|;
comment|// if there's AccessControlContext or subject, we can fail fast
specifier|private
name|boolean
name|anonymous
init|=
literal|false
decl_stmt|;
comment|// otherwise we can cache current subject's principals for faster access
specifier|private
name|Set
argument_list|<
name|Principal
...
try|try
block|{
comment|// check JAAS subject here
name|AccessControlContext
name|acc
init|=
name|AccessController

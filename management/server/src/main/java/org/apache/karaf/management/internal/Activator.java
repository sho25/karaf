...
name|getString
argument_list|(
literal|"jmxmpServiceUrl"
argument_list|,
literal|"service:jmx:jmxmp://"
operator|+
name|jmxmpHost
operator|+
literal|":"
...
name|getString
argument_list|(
literal|"jmxmpObjectName"
argument_list|,
literal|"connector:name=jmxmp"
argument_list|)
argument_list|)
decl_stmt|;
name|long
...
name|put
argument_list|(
literal|"jmx.remote.sasl.callback.handler"
argument_list|,
name|jaasAuthenticator
argument_list|)
expr_stmt|;

...
name|info
argument_list|(
literal|"Creating new instance on SSH port {} and registry port {} / RMI server port {} at: {}"
argument_list|,
operator|new
name|Object
index|[]
...
argument_list|()
decl_stmt|;
comment|// gnodet: Fix SMX4KNL-46: cpu goes to 100% after running the 'instance:create' command

...
init|=
literal|"com.sun.org.apache.xerces.internal"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
parameter_list|()
lambda|->
literal|"attempting to use the platform default XML Schema validator"
argument_list|)
expr_stmt|;
return|return
name|createInstance
...
argument_list|(
literal|"newXMLSchemaFactoryNoServiceLoader"
argument_list|)
decl_stmt|;
specifier|final
name|int
...
return|;
block|}
comment|// Only calls "newXMLSchemaFactoryNoServiceLoader" if it's
specifier|final
name|Class
argument_list|<
name|?
...
specifier|private
name|boolean
name|isSchemaLanguageSupportedBy
parameter_list|(
specifier|final
name|SchemaFactory
name|factory

...
begin_comment
comment|/**  * Installs this ServiceMix instance as a service in your operating systems.   *  * @version $Rev$ $Date$  */
end_comment
...
name|description
operator|=
literal|"Installs this ServiceMix instance as a service in your operating systems."
argument_list|)
specifier|public
class|class
name|InstallCommand
...
name|description
operator|=
literal|"The service name that will be used when installing the service.  Defaults to the directory name of the instance."
argument_list|)
specifier|private
name|String
name|name
...
name|bin
argument_list|,
literal|"servicemix-service.bat"
argument_list|)
expr_stmt|;
...
name|serviceFile
argument_list|,
literal|"macosx/servicemix-service.bat"
argument_list|,
name|props
argument_list|)
expr_stmt|;
...
name|lib
argument_list|,
literal|"linux/libwrapper.jnilib"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|println
argument_list|(
literal|"On Redhat Systems you run:"
argument_list|)
expr_stmt|;
name|io
operator|.

...
begin_comment
comment|//                 Igor E. Poteryaev<jah@mail.ru>
end_comment

begin_comment
comment|//                 Reinhard Deschler<reinhard.deschler@web.de>
end_comment

begin_comment
comment|/**    Most of the work of the {@link org.apache.log4j.PatternLayout} class    is delegated to the PatternParser class.     @author<a href=mailto:"cakalijp@Maritz.com">James P. Cakalic</a>    @author Ceki G&uuml;lc&uuml;    @author Anders Kristensen     @since 0.8.2 */
end_comment
...
comment|/*case 'x':       pc = new BasicPatternConverter(formattingInfo, NDC_CONVERTER);       //LogLog.debug("NDC converter.");       currentLiteral.setLength(0);       break;     case 'X':       String xOpt = extractOption();       pc = new MDCPatternConverter(formattingInfo, xOpt);       currentLiteral.setLength(0);       break;*/
default|default:

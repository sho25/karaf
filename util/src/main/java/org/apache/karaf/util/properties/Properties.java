...
expr_stmt|;
block|}
comment|/**      * Store a properties into a output stream, preserving comments, special character, etc.      * This method is mainly to be compatible with the java.util.Properties class.      *      * @param os an output stream.      * @param comment this parameter is ignored as this Properties      * @throws java.io.IOException      */
specifier|public
name|void
name|store
parameter_list|(
...
comment|// 3: white spaces
comment|// 4: value parsing
name|int
name|state
init|=
literal|0

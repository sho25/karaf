...
block|}
block|}
comment|// optionally set the start level of the bundles
if|if
condition|(
name|level
operator|!=
...
name|msg
init|=
literal|"You are about to designate bundle as a system bundle.  Do you still wish to set the start level (yes/no): "
decl_stmt|;
name|String
name|str
init|=
...
name|println
argument_list|(
literal|"StartLevel service is unavailable for bundle id "
operator|+
name|bundle
argument_list|)
expr_stmt|;

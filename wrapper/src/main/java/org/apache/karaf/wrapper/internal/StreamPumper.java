...
expr_stmt|;
block|}
comment|/**      * Copies data from the input stream to the output stream.      *<p/>      * Terminates as soon as the input stream is closed or an error occurs.      */
specifier|public
name|void
name|run
parameter_list|()
...
return|;
block|}
comment|/**      * Stop the pumper as soon as possible.      *<p/>      * Note that it may continue to block on the input stream      * but it will really stop the thread as soon as it gets EOF      * or any byte, and it will be marked as finished.      */
specifier|public
specifier|synchronized
name|void
name|stop

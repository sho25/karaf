...
name|INTENSITY_BOLD
operator|+
literal|"Solaris/SunOS system detected :"
operator|+
name|INTENSITY_NORMAL
argument_list|)
expr_stmt|;
...
name|println
argument_list|(
literal|"    $ cp /sbin/init.d/template /sbin/init.d/"
operator|+
name|serviceFile
operator|.
name|getName
...
name|println
argument_list|(
literal|"      awk '/# Execute the commands to/{print;print \"                set_return\";next}1' | \\ "
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"      sed 's/CONTROL_VARIABLE/CONTROL_VARIABLE_KARAF/g' | \\ "
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"      sed 's@# Execute the commands to start your subsystem@        "
operator|+
name|serviceFile
operator|.
name|getPath
...
name|println
argument_list|(
literal|"      sed 's@# Execute the commands to stop your subsystem@        "
operator|+
name|serviceFile
operator|.
name|getPath
...
name|println
argument_list|(
literal|"    $ echo CONTROL_VARIABLE_KARAF=1> /etc/rc.config.d/"
operator|+
name|serviceFile
operator|.
name|getName
...
name|println
argument_list|(
literal|"  To start the service when the machine is rebooted for multi-user run level"
argument_list|)
expr_stmt|;
name|System
operator|.

...
condition|)
block|{
comment|// we are on Java> 8 (Java 9, 10, 11, ...)
name|copyFilteredResourceTo
argument_list|(
name|wrapperConf
argument_list|,
literal|"windows64/karaf-wrapper-java11.conf"
argument_list|,
name|props
argument_list|,
name|envs
...
block|{
comment|// we are on Java 8
name|copyFilteredResourceTo
argument_list|(
name|wrapperConf
argument_list|,
literal|"windows64/karaf-wrapper-java8.conf"
argument_list|,
name|props
argument_list|,
name|envs
...
name|wrapperConf
argument_list|,
literal|"windows/karaf-wrapper-java11.conf"
argument_list|,
name|props
argument_list|,
name|envs
...
name|wrapperConf
argument_list|,
literal|"windows/karaf-wrapper-java8.conf"
argument_list|,
name|props
argument_list|,
name|envs
...
name|wrapperConf
argument_list|,
literal|"unix/karaf-wrapper-java11.conf"
argument_list|,
name|props
argument_list|,
name|envs
...
name|wrapperConf
argument_list|,
literal|"unix/karaf-wrapper-java8.conf"
argument_list|,
name|props
argument_list|,
name|envs
